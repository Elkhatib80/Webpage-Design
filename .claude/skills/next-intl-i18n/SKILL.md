---
name: next-intl-i18n
description: next-intl internationalization for multiple locales with locale-prefixed routing, useTranslations/getTranslations patterns, and message file structure. Use when adding translations, creating localized pages, implementing language switchers, or handling locale routing.
---
